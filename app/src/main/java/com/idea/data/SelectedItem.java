...
public class SelectedItem implements Parcelable {
    ...
    public SelectedItem(String id, String name) {
        this(id, name, Config.getApplicationContext().getString(com.idea.pairapp.R.string.st_unknown));
    }
    ...
    public String toString() {
        return name != null ? name : Config.getApplicationContext().getString(com.idea.pairapp.R.string.unknown);
    }
