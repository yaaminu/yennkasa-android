...
class SinchDispatcher extends AbstractMessageDispatcher implements MessageClientListener {
    ...
    synchronized static Dispatcher<Message> getInstance(MessageClient messageClient) {
        if (INSTANCE == null) {
    ...
    private void onFailed(MessageClient messageClient, com.sinch.android.rtc.messaging.Message message, MessageFailureInfo messageFailureInfo) {
        ...
        if (errorType == ErrorType.NETWORK) {
            ...
            onFailed(failedMessage, MessagingUtils.ERROR_NOT_CONNECTED);
        } else {
            onFailed(failedMessage, MessagingUtils.ERROR_UNKNOWN);
        }
    }
