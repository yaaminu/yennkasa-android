...
public class CropImageView extends FrameLayout {
	...
	protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
		...
		if (mBitmap != null) {
			...
			final Rect bitmapRect = ImageViewUtil.getBitmapRectCenterInside(mBitmap.getWidth(), mBitmap.getHeight(),
	...
	public void setImageBitmap(Bitmap bitmap, ExifInterface exif) {
		...
		if (rotate == -1) {
			...
			final Bitmap rotatedBitmap = Bitmap.createBitmap(bitmap, 0, 0, bitmap.getWidth(), bitmap.getHeight(),
					matrix, true);
